...
extension GameScene {
    ...
    func allEvidenceConfigs() -> [EvidenceConfig] {
        return [
            .digRawTissue(at: CGPoint(x:1522.827880859375, y: 801.6600341796875), rewardGroup: "tissue_key", collectedMessage: "A tissue...? That's odd..."),
            .trashCan(at: CGPoint(x: 1205.1734619140625, y: 474.79693603515625), collectedMessage: "An almost-finished corn cob…"),
            .item(.pieceOfCorn, at: CGPoint(x: 1491.677490234375, y: 422.1864929199219), collectedMessage: "Corn…?"),
            .item(.fur, at: CGPoint(x: 1012.4349365234375, y: -241.21438598632812), scale: 0.25, collectedMessage: "Short fur...", zOffset: 10),
            .digRawDig(at: CGPoint(x: -491.4983215332031, y: 796.5868530273438), scale: 0.33, rewardGroup: "dig_raw_dig_key", collectedMessage: "A very clean dig..."),
            .digRawDig(at: CGPoint(x: -1046.8846435546875, y: -500.74884033203125), scale: 0.33, rewardGroup: "dig_raw_dig_key", collectedMessage: "A very clean dig..."),
            .digRawDig(at: CGPoint(x: 1027.91455078125, y: -544.146484375), scale: 0.33, rewardGroup: "dig_raw_dig_key", collectedMessage: "A very clean dig..."),
            .item(.brokenFence, at: CGPoint(x: -374, y: 570), proximityOffset: CGPoint(x: 0, y: 60), collectedMessage: "A broken fence…"),
